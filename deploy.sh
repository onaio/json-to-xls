...
ssh prod '\
    ...
    wget http://nexus.motechproject.org/content/repositories/json-to-xls/io/ei/jsontoxls/json-to-xls/0.2-SNAPSHOT/json-to-xls-0.2-20131107.062824-2.jar && \
    java -jar json-to-xls-0.2-20131107.062824-2.jar'
